        ...
        <form method="POST" action="{{ route('loyalty-program.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-6 col-md-2 field-auto-track">
                    <label class="form-label">Target <span class="text-danger">*</span> <x-tooltip key="loyalty.target" placement="top" /></label>
                ...
                <div class="col-12 col-md-4 field-auto-track">
                    ...
                    <select name="tipe_item" class="form-select">
                        <option value="penjualan" {{ old('tipe_item','penjualan')==='penjualan'?'selected':'' }}>Penjualan (Kopi Drip)</option>
